  ...
  const headerContent = `
    <div class="official-header">
      <div class="header-bg">
        ...
        <div class="dropdown">
          <button class="btn-dark" style="background-color: #dc2626; border-color: #b91c1c; margin-left: 10px;" onclick="if(window.appStorage && window.appStorage.clearPage) window.appStorage.clearPage(window.currentPageKey)">
