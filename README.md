...
- **الهيدر**: ضع صورة الهيدر الرسمي في المسار `assets/header.jpg`. هذه الصورة ستظهر في أعلى كل نموذج وتُستخدم عند تصدير الـ PDF.
- **الشعار**: ضع الشعار في `assets/logo.png`.
- **التذييل**: (اختياري) ضع صورة التذييل في `assets/footer.png`.

## كيفية إضافة نموذج جديد
1. قم بإنشاء ملف HTML جديد داخل مجلد `pages/` (مثال: `pages/new-form.html`).
